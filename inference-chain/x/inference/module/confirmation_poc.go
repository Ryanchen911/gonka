...
func (am AppModule) updateConfirmationWeights(ctx context.Context, event *types.ConfirmationPoCEvent) error {
	...
	am.evaluateConfirmation(ctx, event, &epochGroupData, currentValidatorWeights, params.PocParams, maintenanceAddrs)
...
func (am AppModule) evaluateConfirmation(
	...
	am.checkConfirmationSlashing(ctx, epochGroupData, coefficients, maintenanceAddrs)
}
