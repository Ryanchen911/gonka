...
var (
	...
	MaintenanceReservationsPrefix          = collections.NewPrefix(64)
	MaintenanceReservationCounterPrefix    = collections.NewPrefix(65)
	MaintenanceStatesPrefix                = collections.NewPrefix(66)
	MaintenanceTransitionsPrefix           = collections.NewPrefix(67)
