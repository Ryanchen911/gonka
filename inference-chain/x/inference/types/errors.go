...
var (
	...
	ErrMaintenanceNotImplemented             = sdkerrors.Register(ModuleName, 1175, "maintenance feature not yet implemented")
	ErrMaintenanceDisabled                   = sdkerrors.Register(ModuleName, 1176, "maintenance windows are disabled")
	ErrMaintenanceInsufficientCredit         = sdkerrors.Register(ModuleName, 1177, "insufficient maintenance credit")
	ErrMaintenanceInsufficientLeadTime       = sdkerrors.Register(ModuleName, 1178, "start height does not satisfy minimum scheduling lead time")
	ErrMaintenanceDurationExceeded           = sdkerrors.Register(ModuleName, 1179, "duration exceeds maximum maintenance window blocks")
	ErrMaintenanceConcurrentCountExceeded    = sdkerrors.Register(ModuleName, 1180, "concurrent maintenance participant count cap exceeded")
	ErrMaintenanceConcurrentPowerExceeded    = sdkerrors.Register(ModuleName, 1181, "concurrent maintenance power cap exceeded")
	ErrMaintenanceOverlap                    = sdkerrors.Register(ModuleName, 1182, "maintenance window overlaps existing reservation for this participant")
	ErrMaintenanceAlreadyScheduled           = sdkerrors.Register(ModuleName, 1183, "participant already has a scheduled maintenance window")
	ErrMaintenanceReservationNotFound        = sdkerrors.Register(ModuleName, 1184, "maintenance reservation not found")
